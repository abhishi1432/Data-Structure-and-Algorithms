...
//this will NOT work for undirected graph
//as in undirected ,the link form node 0 to node 1 and back to node 0 , will not be considered as a loop
//but this code will take it as a loop because this similar condition in case of a directed graph is a loop
class Graph
{
