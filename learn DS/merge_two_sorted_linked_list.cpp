...
void print_linked_list(Node* t){Node* temp=t;while(temp!=NULL){cout<<temp->data<<" ";temp=temp->next;}cout<<nline;}

Node* merge_sorted(Node *ptr1,Node *ptr2){   // Fucntion to merge two sorted linked list.
	Node* head_new=NULL;
	Node* tail=NULL;
	if (ptr1==NULL)
		return ptr2;
...
void solve() {
	...
	Node* head_new= merge_sorted(head,head2);
	
	print_linked_list(head_new);
