...
int getSum(int a, int b){
	...
	/*
	Here we are using half adder logic to add two numbers
	Refrence : https://www.geeksforgeeks.org/add-two-numbers-without-using-arithmetic-operators/
	*/
	while(b!=0){
		unsigned carry=a&b;
		a=a^b;
