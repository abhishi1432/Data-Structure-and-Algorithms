...
/*=================================================================*/
void separate_pos_neg_M1(vector<int> &arr){
...
void separate_pos_neg_M2(vector<int> arr){
	int low=0;
	int high=sz(arr)-1;
	while(low<=high){
		if(arr[low]>=0){
...
void separate_pos_neg_M2_updated(vector<int> arr){
...
void solve() {
	vector<int> arr1={1,2,-344,8,6,-5,3,-19,2,2,1,0,-99};
	vector<int> arr2={1,2,-344,8,6,-5,3,-19,2,2,1,0,-99};
	vector<int> arr3={1,2,-344,8,6,-5,3,-19,2,2,1,0,-99};

	/*Complexity of all of the methods is O(n)*/
	
	cout<<"original array: ";
	print_vec(arr1);
	cout<<"Method_1: ";
	separate_pos_neg_M1(arr1);
	cout<<"Method_2: ";
	separate_pos_neg_M2(arr2);
	cout<<"Method2_upd: ";
	separate_pos_neg_M2_updated(arr3);
