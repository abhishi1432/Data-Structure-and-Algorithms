...
int maxSubarraySum(vector<int> arr, int size)
{
    ...
    int start=0,end=0,temp=0;    /*Start and end will contain the indices of the maximum sum subarry*/
...
int maxSubarraySum_M2(vector<int> arr, int size)
{
    ...
    for (int i = 0; i < size; i++) {
        ...
        /* We can write this in just two lines as :-
...
void solve() {
	...
	// result=maxSubarraySum_M2(arr,n);
	// cout<<result<<nline;
    maxProduct(arr,n);
}
