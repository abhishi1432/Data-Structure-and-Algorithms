...
TreeNode* deserialize(string data) {
    TreeNode* ans = deserialize_helper(data);
    return ans;
}
...
void solve() {
	...
	string ans= serialize(root);   //preorder
	/*
						1
					   / \
					  2   3
	...
	*/
	...
	TreeNode *ans2 = deserialize(ans);
	cout<<ans2->val<<nline;
	cout<<ans2->left->val<<nline;
	cout<<ans2->right->val<<nline;
	// cout<<ans2->right->left->val<<nline;
	// cout<<ans2->right->right->val<<nline;
