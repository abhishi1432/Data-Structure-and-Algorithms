...
TreeNode* invertTree(TreeNode* root) {
	// cout<<root->val<<nline;
	// cout<<root->left->val<<" "<<root->right->val<<nline;
	// cout<<root->left->left->val<<" "<<root->left->right->val<<" "<<root->right->left->val<<" "<<root->right->right->val<<nline;
