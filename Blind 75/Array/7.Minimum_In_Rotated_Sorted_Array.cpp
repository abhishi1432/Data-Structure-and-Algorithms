...
/*=================================================================*/
 ...
 int findMin(vector<int>& nums){
 	/*
		Time complexity is O(nlogn)-> log(n) is for map insertion
 	*/
 	int n=nums.size();
 	map<int,int> mp;
 	for(int i=0;i<n;i++){
 ...
 int findMin_2(vector<int> nums){
 	/*
		Time complexity is O(logn)...using modified binary search
...
void solve() {
	...
	vector<int> vec;
	input_vec(vec,n);
	cout<<findMin(vec)<<nline;
	cout<<findMin_2(vec)<<nline;
}
