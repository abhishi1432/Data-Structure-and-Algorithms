...
int Optimized_DP_Space_wiggleMaxLength(vector<int>& nums) {
	/*
	Time complexity : O(n)
	Space complexiy : O(1)
...
int wiggleMaxLength(vector<int>& nums) {
   	// return greedy_wiggleMaxLength(nums);
   	// return DP_wiggleMaxLength(nums);
   	return Optimized_DP_Space_wiggleMaxLength(nums);
}
