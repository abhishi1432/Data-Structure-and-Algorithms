...
/*=================================================================*/
// int maxResult_naive(int start,int ind, int k, vector<int>& nums) {
// 	int sum = INT_MIN;
// 	if(ind >= nums.size())
// 		return 0;
// 	int localSum = 0;
//     for(int i = start+1; i <= k && i < nums.size(); i++){
//     	debug(localSum);
//     	localSum += nums[ind] + maxResult_naive(i,ind+i,k,nums);
//     }
...
// }
int maxResult_DP(vector<int>& nums, int k) {
      int n=nums.size();
      vector<int>dp(n,0);
...
int maxResult(vector<int>& nums, int k) {
	// return maxResult_naive(0,k,nums);
}
